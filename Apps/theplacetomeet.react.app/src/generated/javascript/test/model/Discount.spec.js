...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaceToMeetWebApi.Discount();
  });
  ...
  describe('Discount', function() {
    it('should create an instance of Discount', function() {
      ...
      //var instance = new ThePlaceToMeetWebApi.Discount();
      //expect(instance).to.be.a(ThePlaceToMeetWebApi.Discount);
    });
    ...
    it('should have the property minimumReservationsInAYear (base name: "minimumReservationsInAYear")', function() {
      // uncomment below and update the code to test the property minimumReservationsInAYear
      //var instance = new ThePlaceToMeetWebApi.Discount();
      //expect(instance).to.be();
    });
