...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaceToMeetWebApi.ProblemDetails();
  });
  ...
  describe('ProblemDetails', function() {
    it('should create an instance of ProblemDetails', function() {
      ...
      //var instance = new ThePlaceToMeetWebApi.ProblemDetails();
      //expect(instance).to.be.a(ThePlaceToMeetWebApi.ProblemDetails);
    });
