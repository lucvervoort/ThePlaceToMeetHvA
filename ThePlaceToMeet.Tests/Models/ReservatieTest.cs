...
namespace ThePlaceToMeet.Tests.Models
{
    public class ReservatieTest
    {
        ...
        {
            Reservation r = new () { Dag = _context.Dag.AddDays(12), AantalPersonen = 10, BeginUur = 8, PrijsPerUur = 15, DuurInUren=3 };
        ...
        {
            Reservation r = new () { Dag = _context.Dag.AddDays(12), AantalPersonen = 10, BeginUur = 8, PrijsPerUur = 15, DuurInUren = 3, Catering=_context.CateringSushi, PrijsPerPersoonCatering=11, PrijsPerPersoonStandaardCatering=9};
        ...
        {
            Reservation r = new () { Dag = _context.Dag.AddDays(12), AantalPersonen = 10, BeginUur = 8, PrijsPerUur = 15, DuurInUren = 3, Catering = _context.CateringSushi, PrijsPerPersoonCatering = 11, PrijsPerPersoonStandaardCatering = 9, Korting = _context.Kortingen.First() };
        ...
        {
            Reservation r = new () { Dag = DateTime.Today.AddDays(12), AantalPersonen = 10, BeginUur = 8, PrijsPerUur = 15, DuurInUren = 3, Korting = _context.Kortingen.First() };
