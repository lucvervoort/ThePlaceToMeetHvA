...
namespace ThePlaceToMeet.Tests.Models
{
    public class VergaderruimteTest
    {
        ...
        private readonly MeetingRoom _vergaderruimte;
        private readonly Customer _klantMetVierReservaties;
        private readonly Customer _klantMetTweeReservaties;
        private readonly Customer _klantZonderReservaties;
        ...
        {
            Reservation r = _vergaderruimte.Reserveer(_klantZonderReservaties, _context.Kortingen, _context.Dag.AddDays(12), beginUur, aantalUren, 10, _context.CateringSushi, true);
        ...
        {
            Reservation r = _vergaderruimte.Reserveer(_klantZonderReservaties, _context.Kortingen, DateTime.Today.AddDays(12), 20, 2, 10, _context.CateringSushi, true);
        ...
        {
            Reservation r1 = _vergaderruimte.Reserveer(_klantMetTweeReservaties, _context.Kortingen, _context.Dag.AddDays(20), 8, 3, 10, _context.CateringSushi, true);
            Assert.Equal(_context.Kortingen.First(), r1.Korting);
            Reservation r2 = _vergaderruimte.Reserveer(_klantMetTweeReservaties, _context.Kortingen, _context.Dag.AddDays(21), 8, 3, 10, _context.CateringSushi, true);
        ...
        {
            Reservation r1 = _vergaderruimte.Reserveer(_klantMetVierReservaties, _context.Kortingen, _context.Dag.AddDays(20), 8, 3, 10, _context.CateringSushi, true);
            Assert.Equal(_context.Kortingen.Last(), r1.Korting);
            Reservation r2 = _vergaderruimte.Reserveer(_klantMetVierReservaties, _context.Kortingen, _context.Dag.AddDays(21), 8, 3, 10, _context.CateringSushi, true);
